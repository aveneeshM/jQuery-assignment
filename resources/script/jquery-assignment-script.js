$(document).ready(function() {
    ...
    var partnerName = ["<span ><img src='resources/images/flipkart.png' align='middle' width='auto' height='35'><span>", 
    "<span><img src='resources/images/amazon.png' alt='amazon' width='auto' height='35'></span>", 
    "<span><img src='resources/images/Myntra_logo.png' alt='fkart' width='auto' height='35'></span>"];
    var span = $("#partnerName");
    animate();
    function animate(){
        span.add().html(partnerName[i]).fadeIn(1000).delay(500).fadeOut(1000);
        i+=1;
        if(i==3){i=0;}
        span.animate({width: 100},animate);
    }
    ...
    $('#fname').change(function() {
	    ...
	    if(!f_name){
	    	...
	    	$('#fnamemsg').text("*Required Field*");
            $("#fname").focus();
	    }
	    else if(!f_name.match(name_regex)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#fnamemsg').text("*Please use alphabets only. *");
            $("#fname").focus();
	    }
	    else{
	    	input.removeClass("invalid").addClass("valid");
	        $('#fnamemsg').text(""); 
	       // $('#fnamemsg').prepend($('<img>',{id:'theImg',src:'correct.gif', height:'17px',width:'17px'})).delay(1200);
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#fnamemsg").delay(1500); 
            img.fadeOut(1000);
	    }
	});
	...
	$('#lname').change(function() {
	    ...
	    if(!l_name){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#lnamemsg').text("*Required Field*");
            $("#lname").focus();
	    }
	    else if(!l_name.match(name_regex)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#lnamemsg').text("*Please use alphabets only. *");
            $("#lname").focus();
	    }
	    else{
	    	input.removeClass("invalid").addClass("valid");
	        $('#lnamemsg').text(""); 
	       // $('#fnamemsg').prepend($('<img>',{id:'theImg',src:'correct.gif', height:'17px',width:'17px'})).delay(1200);
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#lnamemsg").delay(1500); 
            img.fadeOut(1000);
    ...
    $('#datetext').change(function() {
        var dateob =$(this);
        var dateobirth =dateob.val();
        if(dateobirth == "" || dateobirth == null){
    	    dateob.removeClass("valid").addClass("invalid");
        }
        else{
    	    dateob.removeClass("invalid").addClass("valid");
    	    var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#dobmsg").delay(1500); 
            img.fadeOut(1000);
        }
    });
    ...
    $('#interest').change(function() {
	    var input=$(this);
	    var P_interest=input.val();
	    if(!P_interest){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#interestmsg').text("*Required Field*");
            $("#interest").focus();
	    }
	    else if(P_interest.match(ptrn1)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#interestmsg').text("*Please use alphabets only. Separate multiple interest with space*");
            $("#interest").focus();
	    }
	    else if(P_interest.match(ptrn2)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#interestmsg').text("*Can not have trailing or preceding spaces!!*");
            $("#interest").focus();
	    }
	    else{
	    	input.removeClass("invalid").addClass("valid");
	        $('#interestmsg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#interestmsg").delay(1500); 
            img.fadeOut(1000);
    ...
    $('#num').change(function() {
	    ...
	    if(!num){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#num_msg').text("*Required Field*");
            $("#num").focus();
	    }
	    else if(!num.match(num_regex)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#num_msg').text("*Enter a valid 10 digit number*");
            $("#num").focus();
	    	...
	    	input.removeClass("invalid").addClass("valid");
	        $('#num_msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#num_msg").delay(1500); 
            img.fadeOut(1000);
    ...
    $('#num2').change(function() {
	    ...
	    if(!num2){
	    	input.removeClass("valid").addClass("invalid");
	        $('#num2_msg').text("*Required Field*");
	        $("#num").focus();
	    }
	    else{
	        if(!num2.match(num_regex)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#num2_msg').text("*Enter a valid 10 digit number*");
            $("#num2").focus();
	    	...
	    	input.removeClass("invalid").addClass("valid");
	        $('#num2_msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#num2_msg").delay(1500); 
            img.fadeOut(1000);
	    }
	}
    });
...
$('#address').change(function() {
	    ...
	    if(!address){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#address_msg').text("*Required Field*");
            $("#address").focus();
	    }
	    else if(!address.match(address_regex)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#address_msg').html("Allowed special characters:&nbsp;<b style='color:red;'> ./,(-)</b>");
            $("#address").focus();

	    }
	    else if(address.match(ptrn2)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#address_msg').text("Don't use extra spaces!!");
            $("#address").focus();
	    	...
	    	input.removeClass("invalid").addClass("valid");
	        $('#address_msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#address_msg").delay(1500); 
            img.fadeOut(1000);
	    }
    });
// Countries
...
$('#country').change(function() {
	$('#state').empty();
	    var input=$(this);
	    var selected_country=input.val();
	    if(selected_country != "Select Country"){
	    	input.removeClass("invalid").addClass("valid");
	        $('#countrymsg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#countrymsg").delay(1500); 
            img.fadeOut(1000);
            var selectedCountryIndex =input.prop('selectedIndex');
            var state_arr = s_a[selectedCountryIndex].split("|");
            state_arr.unshift('Select State');
        	...
        	input.removeClass("valid").addClass("invalid");
	        $('#countrymsg').text("*Required Field*");
        }
...
$('#state').change(function() {
	var input=$(this);
	    ...
	    if(selected_state != "Select State"){
	    	input.removeClass("invalid").addClass("valid");
	        $('#statemsg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#statemsg").delay(1500); 
            img.fadeOut(1000);
            }
        else{
        	input.removeClass("valid").addClass("invalid");
	        $('#statemsg').text("*Required Field*");
        }  
    });
...
$('#city').change(function() {
	    ...
	    if(!city){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#citymsg').text("*Required Field*");
            $("#city").focus();
	    }
	    else if(city.match(ptrn1)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#citymsg').text("*Please use words only.*");
            $("#city").focus();

	    }
	    else if(city.match(ptrn2)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#citymsg').text("*Can not have trailing or preceding spaces!!*");
            $("#city").focus();
	    }
	    else{
	    	input.removeClass("invalid").addClass("valid");
	        $('#citymsg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#citymsg").delay(1500); 
            img.fadeOut(1000);
	    }
});
...
$('#zip').change(function() {
	    ...
	    if(!zipcode){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#zipmsg').text("*Required Field*");
            $("#zip").focus();
	    }
	    else if(!zipcode.match(zipRegex) || zipcode == "000000"){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#zipmsg').text("*Enter a valid ZIP code*");
            $("#zip").focus();
	    }
	    	...
	    	input.removeClass("invalid").addClass("valid");
	        $('#zipmsg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#zipmsg").delay(1500); 
            img.fadeOut(1000);
	    }
});


$('#addressPermanent').change(function() {
	    var input=$(this);
	    var address=input.val();
	    if(!address){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#addressPermanent_msg').text("*Required Field*");
            $("#addressPermanent").focus();
	    }
	    else if(!address.match(address_regex)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#addressPermanent_msg').html("Allowed special characters:&nbsp;<b style='color:red;'> ./,(-)</b>");
            $("#addressPermanent").focus();
	    }
	    else if(address.match(ptrn2)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#addressPermanent_msg').text("Don't use extra spaces!!");
            $("#addressPermanent").focus();
	    }
	    else{
	    	input.removeClass("invalid").addClass("valid");
	        $('#addressPermanent_msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#addressPermanent_msg").delay(1500); 
            img.fadeOut(1000);
	    }
    });
...
$('#country1').change(function() {
	$('#state1').empty();
	    ...
	    if(selected_country != "Select Country"){
	    	input.removeClass("invalid").addClass("valid");
	        $('#country1msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#country1msg").delay(1500); 
            img.fadeOut(1000);
            var selectedCountryIndex =input.prop('selectedIndex');
            var state_arr = s_a[selectedCountryIndex].split("|");
            state_arr.unshift('Select State');
        	...
        	input.removeClass("valid").addClass("invalid");
	        $('#country1msg').text("*Required Field*");
...
$('#state1').change(function() {
	var input=$(this);
	    ...
	    if(selected_state != "Select State"){
	    	input.removeClass("invalid").addClass("valid");
	        $('#state1msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#state1msg").delay(1500); 
            img.fadeOut(1000);
            }
        else{
        	input.removeClass("valid").addClass("invalid");
	        $('#state1msg').text("*Required Field*");
...
$('#city1').change(function() {
	    ...
	    if(!city1){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#city1msg').text("*Required Field*");
            $("#city1").focus();
	    }
	    else if(city1.match(ptrn1)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#city1msg').text("*Please use words only.*");
            $("#city1").focus();

	    }
	    else if(city1.match(ptrn2)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#city1msg').text("*Can not have trailing or preceding spaces!!*");
            $("#city1").focus();
	    	...
	    	input.removeClass("invalid").addClass("valid");
	        $('#city1msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#city1msg").delay(1500); 
            img.fadeOut(1000);
...
$('#zip1').change(function() {
	    var input=$(this);
	    var zipcode1=input.val();
	    if(!zipcode1){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#zip1msg').text("*Required Field*");
            $("#zip1").focus();
	    }
	    else if(!zipcode1.match(zipRegex) || zipcode1 == "000000"){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#zip1msg').text("*Enter a valid ZIP code*");
            $("#zip1").focus();
	    }
	    	...
	    	input.removeClass("invalid").addClass("valid");
	        $('#zip1msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#zip1msg").delay(1500); 
            img.fadeOut(1000);
...
$('#mail').change(function() {
	    ...
	    if(!mail){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#mailmsg').text("*Required Field*");
            $("#mail").focus();
	    }
	    else if(!mail.match(emailReg)){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#mailmsg').text("*Input valid email address*");
            $("#mail").focus();
	    }
	    else{
	    	input.removeClass("invalid").addClass("valid");
	        $('#mailmsg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#mailCorrect_msg").delay(1500); 
            img.fadeOut(1000);
	    }
	});
var passwordRef;
...
$('#pwd').change(function() {
	    ...
	    if(!pwd){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#pwdmsg').text("*Required Field*");
            $("#pwd").focus();
	    }
	    else if(!pwd.match(pwdReg)){
	        $('#pwd1msg').text(""); 
	    	input.removeClass("valid").addClass("invalid");
	    	alert("*Password must contain at least one number, a uppercase letter,a lowercase letter and must have at least 8 characters*");
            $("#pwd").focus();
        }
        else if(pwd != $("#pwd1").val() && $("#pwd1").val().length > 0){
        	$("#pwd1").removeClass("valid").addClass("invalid");
	    	$('#pwd1msg').text("*Passwords do not match*");
            $("#pwd1").focus();
        }
	    else{
	    	input.removeClass("invalid").addClass("valid");
	        $('#pwdmsg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#pwdCorrect_msg").delay(1500); 
            img.fadeOut(1000);
	    }
	});
...
$('#pwd1').change(function() {
	    ...
	    if(!pwd1){
	    	input.removeClass("valid").addClass("invalid");
	    	$('#pwd1msg').text("*Required Field*");
            $("#pwd1").focus();
	    }
	    else if(!pwd1.match(pwdReg)){
	        $('#pwd1msg').text(""); 
	    	input.removeClass("valid").addClass("invalid");
	    	alert("*Password must contain at least one number, a uppercase letter,a lowercase letter and must have at least 8 characters*");
            $("#pwd1").focus();
	    	...
	    	input.removeClass("invalid").addClass("valid");
	        $('#pwd1msg').text(""); 
            var img = $("<img src='resources/images/correct.gif' width='16px' height='16px' />").prependTo("#pwd1Correct_msg").delay(1500); 
            img.fadeOut(1000);
	    }
	});
var total;
function genCaptcha(){
  ...
  if (ran3==1) {
    $("#captchha").html(randomNum1+"&nbsp;+&nbsp;"+randomNum2+"&nbsp;=");
...
$('#captchasubmit').click(function(){
  ...
  if(total != $("#soln").val()){
    $("#suptext").html("Refresh to retry");
    $("#soln").removeClass("valid").addClass("invalid");
    var btn = $("#captchasubmit");
    btn.prop('disabled', true);
  }
  else{
    $("#truecaptcha").html("<b><i>Captcha submitted successfully!!</b></i>");
    $("#finalsubmit").prop('disabled', false);
  }
});
$('#captcharefresh').click(function(){
	$("#soln").removeClass("valid").removeClass("invalid");
  $("#suptext").html("");
  var btn = $("#captchasubmit");
...
$("#myForm").submit(function(){
	if ($("#fname").val() == "" || $("#lname").val() == "" || $("#datetext").val() == "" || $("#interest").val() == "" ||
	 $("#num").val() == "" || $("#num2").val() == "" || $("#address").val() == "" || $("#zip").val() == "" || $("#city").val() == "" ||
	  $("#addressPermanent").val() == "" || $("#city1").val() == "" || $("zip1").val() == "" || $("#mail").val() == "" ||
	   $("#pwd").val() == "" || $("#pwd1").val() == ""){
		alert("Input Fields can not be empty!! All fields are required.");
		return false;
	}
	
	if($("#country").val() == "Select Country"){
		$("#country").removeClass("valid").addClass("invalid");
		alert("select the present country field");
	        $('#countrymsg').text("*Required Field*");
	        return false;
	...
	if($("#state").val() == "Select State"){
		...
		alert("select the present state field");
	        $('#statemsg').text("*Required Field*");
	        return false;
	}
	if($("#country1").val() == "Select Country"){
		$("#country1").removeClass("valid").addClass("invalid");
            alert("select the permanent country field");
	        $('#country1msg').text("*Required Field*");
	        return false;

	}
	if($("#state1").val() == "Select State"){
		$("#state1").removeClass("valid").addClass("invalid");
		alert("select the permanent state field");
	        $('#state1msg').text("*Required Field*");
	        return false;
	}
	if($("input").hasClass("invalid") || $("textarea").hasClass("invalid")){
		alert("Input Valid Data at Fields marked with Red and Resubmit!!");
		return false;
	}
...
$(window).scroll(function(event){
   ...
   if (st > lastScrollTop){
      $('body').css({
    background: "-webkit-gradient(linear, left top, left bottom, from(#ffffff), to(#a9cce3))" 
});
   } else {
    $('body').css({
    background: "-webkit-gradient(linear, left top, left bottom, from(#a9cce3), to(#ffffff))" 
});
   }
   lastScrollTop = st;
});
